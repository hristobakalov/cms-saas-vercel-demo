 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "fragment DividerElementData on DividerElement {\n  divider: _metadata {\n    key\n  }\n}"): (typeof documents)["fragment DividerElementData on DividerElement {\n  divider: _metadata {\n    key\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query searchContent($term: String!, $topInterest: String, $locale: [String!], $withinLocale: [Locales], $types: [String!], $pageSize: Int, $start: Int) {\n  Content: _Content(\n    where: {_or: [{_fulltext: {match: $term}}, {_fulltext: {match: $topInterest, boost: 200}}], _metadata: {types: {in: \"_Page\"}}}\n    orderBy: {_ranking: SEMANTIC}\n    limit: $pageSize\n    skip: $start\n    locale: $withinLocale\n  ) {\n    total\n    items {\n      _score\n      ...SearchData\n      _metadata {\n        published\n      }\n      preview: _fulltext(\n        highlight: {enabled: true, startToken: \"<span>\", endToken: \"</span>\"}\n      )\n    }\n    facets {\n      _metadata {\n        types(filters: $types) {\n          name\n          count\n        }\n        locale(filters: $locale) {\n          name\n          count\n        }\n      }\n    }\n  }\n}\n\nfragment SearchData on _IContent {\n  ...IContentData\n}"): (typeof documents)["query searchContent($term: String!, $topInterest: String, $locale: [String!], $withinLocale: [Locales], $types: [String!], $pageSize: Int, $start: Int) {\n  Content: _Content(\n    where: {_or: [{_fulltext: {match: $term}}, {_fulltext: {match: $topInterest, boost: 200}}], _metadata: {types: {in: \"_Page\"}}}\n    orderBy: {_ranking: SEMANTIC}\n    limit: $pageSize\n    skip: $start\n    locale: $withinLocale\n  ) {\n    total\n    items {\n      _score\n      ...SearchData\n      _metadata {\n        published\n      }\n      preview: _fulltext(\n        highlight: {enabled: true, startToken: \"<span>\", endToken: \"</span>\"}\n      )\n    }\n    facets {\n      _metadata {\n        types(filters: $types) {\n          name\n          count\n        }\n        locale(filters: $locale) {\n          name\n          count\n        }\n      }\n    }\n  }\n}\n\nfragment SearchData on _IContent {\n  ...IContentData\n}"];
